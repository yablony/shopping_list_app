...
from controllers.shopping_list_controllers import index, new, update, edit, delete_item, delete_all, add_ingredients
...
shopping_list_routes.route('/add_ingredients', methods=["POST"])(add_ingredients)